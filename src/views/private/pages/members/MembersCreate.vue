                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <b-form-group class="">
                                    ...
                                    <select v-model="form.gender" class="form-control" required>
                                        <option value=null> -- Select Type-- </option>
                                        <option v-for="option in gender" :value="option.value" :key="option.value">
                                            {{ option.text }}
                                        </option>
                                    </select>
                                </b-form-group>
                            ...
                            <div class="col-md-3">
                                <b-form-group class="">
                                    ...
                                    <select v-model="form.state_of_origin" class="form-control" @change="onChange($event)" required>
                                        ...
                                        <option v-for="option in states" :value="option.id" :key="option.id">
                                            {{ option.title }}
                                        </option>
                                    </select>
                                </b-form-group>
                            ...
                            <div class="col-md-3">
                                <b-form-group class="">
                                    ...
                                    <option v-for="option in lgas" :value="option.id" :key="option.id">
                                        {{ option.name }}
                                    </option>
                                    </select>
                                </b-form-group>
                            ...
                            <b-card-body>
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select v-model="form.marital_status" class="form-control" required>
                                            <option value=null> -- Select -- </option>
                                            <option v-for="option in marital_status" :value="option.value" :key="option.value">
                                                {{ option.text }}
                                            </option>
                                        </select>
                                    </div>
...
<script setup>
  ...
  const filters = ref({
    ...
    const uploadImage = (e) => {
        ...
        Swal("Failed!", "Oops, You are uploading a large file, try again. Upload file less than 8MB", "warning");
      }
    };
