  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center row">
            ...
            <div class="col-md-6">
                <b class="mr-3">Debt: </b> <span v-html="nairaSign"></span>{{ formatPrice(totalDebt) }} <span class="mx-3 text-success">|</span> <b class="mr-3">Wallet Balance : <span v-html="nairaSign"></span>{{ formatPrice(wallet) }}</b>
            </div>
        </div>
        <TabView>
                        ...
                        <div class="table-responsive"> 
                            <table  class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>{{ member.address }} {{ member.city_resident }}, {{ member.stateResidence}} State, {{ member.country }}</td>
                                </tr>
