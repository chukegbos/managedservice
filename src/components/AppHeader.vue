...
const toggleSidebar = () => {
  if (
    !document.querySelectorAll(".body")[0].classList.contains("mini-sidebar")
  ) {
...
const toggleDropdown = () => {
  ...
  if (!element.value[num].classList.contains("show")) {
    ...
    element2[num].style.cssText =
      "position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(10px, 42px); overflow: hidden;";
  } else {
...
const toggleDropdownMobile = () => {
  ...
  if (!element.value[num].classList.contains("show")) {
    ...
    element2[num].classList.add("show");
    element2[num].style.cssText =
      "position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(-110px, 42px); overflow: hidden;";
  } else {
    element.value[num].setAttribute("aria-expanded", "false");
    element.value[num].classList.remove("show");
...
const toggleProfile = () => {
  ...
  if (!element.value[num].classList.contains("show")) {
    ...
    element2[num].classList.add("show");
    element2[num].style.cssText =
      "position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(-50px, 42px); overflow: hidden;";
  } else {
    element.value[num].setAttribute("aria-expanded", "false");
    element.value[num].classList.remove("show");
...
const toggler = (index, num) => {
  ...
  if (!element2.value[num].classList.contains("show")) {
    ...
    element2.value[num].style.cssText =
      "position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(" +
      translate +
...
const toggleMobile = () => {
  if (
    !document
      .querySelectorAll(".main-wrapper")[0]
      .classList.contains("slide-nav")
  ) {
